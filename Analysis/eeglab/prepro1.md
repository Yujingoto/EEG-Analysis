...
今回で基本的な前処理は出来たので，次回はやや[発展的な前処理](./prepro2.html)です．\
あるいは，基礎の前処理だけで大丈夫な人は[解析](./analysis1.html)に行ってしまっても大丈夫です．筆者も基本このページに載せたことくらいしかしていません．