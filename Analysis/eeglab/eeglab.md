...
<h1><span></span>EEGLAB入門</h1>

[EEGLAB](http://sccn.ucsd.edu/eeglab/)はMATLAB上で動くEEG用ソフトウェアです. GUIベース，つまりプログラムを自分で書くことなくボタンをポチポチしてるだけで脳波の解析をすることができます．まずこいつを使って脳波解析の流れに触れていきましょう．
