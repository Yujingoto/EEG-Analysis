...
<h1><span></span>計算機シミュレーション</h1>

本編では，情報屋ではない生物屋の目線から計算論的神経科学(的な...?)を学んでいく上で，勉強した事柄をまとめていきます．


力学系のシミュレーションやニューラルネットワークの実装，今流行りの自由エネルギー原理あたりに触れていけたら楽しいなと，考えています．

## 目次
- [環境構築](./Setup/Setup.html)
- [非線形力学](./NonlinearDynamics/Nonlinear-dynamics.html)
