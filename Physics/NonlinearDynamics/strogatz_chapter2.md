...
この資料は身内勉強会で Steven H. Strogatz, [非線形ダイナミクスとカオス](https://amzn.asia/d/a5c49t4), 1994 の第 2 章前半を担当した際のまとめ用です．いずれ他ページに吸収されて消えます．
...
このように，科学は系 ($S$) と外界 ($E$)，外界から系への作用 ($A: E \to S$)，系の時間発展 ($D$) の仮定に何を置いているかを意識すると見通しが良い (個人の感想です)．
...
と書ける．$\eta$ についての線型方程式になるので，この操作を **$x^\*$ のまわりの線形化**と呼ぶ．この式は摂動 $\eta(t)$ が$f'(x^\*)>0$ なら指数関数的に成長し，逆なら減衰することを意味する．ただし，もし $f'(x^\*)=0$ の場合，2次の項が支配項になるのでそちらが安定性を決める．が一般に言えることは無くなる．この例は[例題](#例題)で触れる．より一般な議論は今後，議論が多次元に拡張された際，**ハートマン・グロブマンの定理**で与えられる．
...
$f'(x^\*) =0$ ということは, 固定点の左右それぞれについて，$\dot{x}$ が正，負，あるいはゼロのいずれであるかによって振る舞いが変わる．たとえば
