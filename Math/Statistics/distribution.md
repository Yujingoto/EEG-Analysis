...
基礎編に乗っているような[基礎統計量だけの議論](../Basic/statistics.html)では必要ないため，(多分)高校数学ではやりませんが，それ以上の統計学をやる上で必須になってくるのが確率分布の概念です．
...
中でも**正規分布**という分布は重要で，[中心極限定理](./central_limit_theorem.html)という定理が示すように世の中の多くの事象に適用できる分布の形です．
...
F分布は, 少し特殊な形をしていますが非常に重要です. どう重要かというと，これまでの分布と異なり, **２つの母集団から得られた標本分散の比の確率分布**になります．これによって，[分散分析，ANOVA](./anova.html)と呼ばれる統計的検定に使うことになるので，しっかりと確認しておきます．
