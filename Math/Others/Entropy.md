...
あと，KL "距離" と日本語で呼んでいますが**厳密には距離じゃない**ので注意が必要です．というのも，KLDは以下に示す距離の公理を満たしていないからです．
...
あとは，一様分布と得られたデータ分布との距離を測る，なんて使い方もありました. この場合は正規化的なのして，$\mathbb{D}_{KL}(P||U)$(where U is the uniform dist)を0-1の値にして使ってましたね．
