...
ここには，もはや基礎数学ではないし，脳波解析などに必須な信号処理や統計学とも少し離れる数学を散発的に置いておきます．人によっては必要になりますし，特に**情報寄りのアプローチ**での解析を使いたい人や，何気なく使っている**ICAなどの処理**についてちゃんと勉強したい人，より**発展的な解析**をしたい人なんかに向けた内容となっています．


## 目次
- [ラグランジュの未定乗数法](lagrange.html)
- [正準相関分析](CCA.html)
- [主成分分析](PCA.html)
- [独立成分分析](ICA.html)
- [エントロピーと分布間距離](Entropy.html)
- [信号検出理論](signal_detection.html)
